...
\progresscheck%毕业论文(设计)过程检查情况记录表
\record%毕业论文(设计)答辩情况登记表
\disclaim%学术诚信声明
...
%以下是参考文献条目（非常抱歉未支持bibtex）
\bibitem{journal} 作者. 文章题目[J]. 期刊名, 出版年份,卷号(期数):起止页码.
\bibitem{book} 作者. 书名[M]. 版次. 出版地:出版单位,出版年份:起止页码.
\bibitem{conferencepaper} 作者. 文章题目[A].主编.论文集名[C], 出版地:出版单位,出版年
\bibitem{thesis} 作者. 论文题目[D].保存地:保存单位,年份.
\bibitem{report} 报告者. 报告题目[R].报告地:报告会主办单位,报告年份.
\bibitem{patent} 专利所有者. 专利名称:专利国别,专利号[P].发布日期.
\bibitem{standard} 标准代号. 标准名称[S].出版地:出版单位,出版年份.
\bibitem{newspaper} 作者. 文章题目[N].报纸名,出版日期(版次).
\bibitem{eresource} 作者.文献题目[电子文献及载体类型标识].电子文献的可获取地址,发表或更新日期/引用日期(可以只选择一项).
\end{thebibliography}
